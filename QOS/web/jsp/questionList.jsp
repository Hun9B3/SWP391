                ...
                <div class="col-md-8" id="form" style="min-height: 480px; min-width: 1000px">
                    <div class="container" >
                        ...
                        <div class="form-group">                           
                            ...
                            <a href="${contextPath}/quizController?service=getQuestionDetailsInformation"><button class="btn btn-success" style="float:right;margin: 5px">Add new Question</button></a>
