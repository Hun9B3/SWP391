            ...
            <div class="row">
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <c:forEach items="${lastBlogs}" var="blog">
                            <div class="lastposts" style=" display: flex;margin-top: 20px; border: 1px #bccafd solid;" >
                                ...
                                <div>
                                    <a style="text-decoration: none;color: black;" href="${contextPath}BlogController?service=blogDetail&blogId=${blog.getBlogId()}"><h6>${blog.getBlogTitle()}</h6></a>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
                ...
                <div class="right col-9">
                    <div style="margin-left:9%;">
                        <div class ="row">
                            <div>
                                <a href="${contextPath}/BlogController?service=blogList" style="text-decoration:none;color:black;"><h3 class="head col-3">ALL BLOGS</h3></a>
                            </div>             
                        </div>
                            ...
                            <c:forEach items="${blogList}" var="blog">
                                <div class="card" style="width: 18rem;margin-bottom: 20px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${blog.getDetail().length() <= 30}">
                                            <p class="card-text"><c:out value="${blog.getDetail()}"/>. . .</p>
                                        </c:if>
                                        <c:if test="${blog.getDetail().length() > 30}">
                                        <p class="card-text"><c:out value="${blog.getDetail().substring(0, 31)}"/>. . .</p>                                  
                                        </c:if>
