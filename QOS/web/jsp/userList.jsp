                    ...
                    <div class="col-md-8" id="form" style="min-height: 480px; min-width: 1000px">
                        <div class="container" >
                            ...
                            <div class="form-group">
                                <a href="${pageContext.request.contextPath}/jsp/addNewAccount.jsp"><button class="btn btn-success" style="float:right;margin: 5px">Add new User</button></a>
                            </div>
                            <%-- Table of User List--%>
                                        ...
                                        <c:otherwise>
                                            <c:forEach items="${userPageList}" var="userList">
                                                <tr>
                                                    ...
                                                    <td><a href="deleteAccount?id=${userList.getUserId()}"><div class="btn btn-success">Change Status</div></a></td>
                                                </tr>
                                            </c:forEach> 
                                        </c:otherwise>
                                    </c:choose>
